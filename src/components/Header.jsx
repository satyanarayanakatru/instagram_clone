  ...
  return (
    <div className="shadow-sm border-b sticky top-0 bg-white z-30 p-3">
      ...
      {isOpen && (
        <Modal
          isOpen={isOpen}
          className="max-w-lg w-[90%] p-6 absolute top-56 left-[50%] translate-x-[-50%] bg-white border-2
        ...
        >
          <div className="flex flex-col justify-center items-center h-[100%]">
            {selectedFile ? (
              <img
                ...
                src={imageFileUrl}
                alt="selected file"
                className={`w-full max-h-[300px] object-over cursor-pointer
          ...
          <button
           ...
           hover:brightness-105 disabled:bg-gray-200 disabled:cursor-not-allowed disabled:hover:brightness-100"
          >
            Upload Post
          </button>
          <AiOutlineClose
            className="cursor-pointer absolute
           top-2 right-2 hover:text-red-600 transition duration-300"
